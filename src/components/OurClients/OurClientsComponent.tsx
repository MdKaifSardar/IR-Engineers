...
const OurClientsComponent = () => {
  return (
    <div className="gap-2 md:gap-4 py-5 md:py-10 w-full flex flex-col justify-center items-center">
      <div className="sm:text-4xl font-bold text-3xl">{MainContent.title}</div>
      ...
      <div>
        <button className="border-0 lg:border-[1px] bg-[#003F63] text-white md:text-black md:bg-transparent border-black px-5 py-2">{MainContent.buttonText}</button>
      </div>
    </div>
  );
};
